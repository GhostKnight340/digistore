...
// Schema (DDL) is owned by Prisma Migrate and applied at deploy time via
// `prisma migrate deploy` (see scripts/prisma-migrate.mjs, wired into the Vercel
// build). This bootstrap only seeds default catalog/settings data — no DDL.
