...
- **This document evolves.** It is expected to change after every major release.
  Items move between sections; completed items are archived (see §6).
...
- **Every new idea is evaluated against this roadmap.** Before building anything
  ...
  Product Principles in §5. If it does not earn a place, it waits.
...
## Priority 1 — Reliability, trust, and operating leverage
...
> capture direction, not commitment.

- **AI** — product recommendations, support-reply drafting, anomaly detection on
  orders/payments.
...
- **Referral system** — reward customers for bringing new buyers.
- **Loyalty program** — points/tiers for repeat purchases.
- **Gift purchases** — buy a code as a gift, deliver to a recipient.
- **Affiliate system** — external partners earn on referred sales.
- **Creator / streamer partnerships** — Discord-native creator storefronts.
- **Community** — Discord-integrated community perks, roles for buyers.
- **Gamification** — badges, streaks, launch-day drops.
- **Live chat** — real-time support beyond the ticket system.
- **Voice search** — hands-free catalogue search.
- **Advanced analytics** — cohort/LTV/funnel dashboards beyond the P1 basics.
- **Mobile app** — native wrapper (a PWA manifest already exists as a foundation).
- **Navigator expansion** — deeper guided browsing/region navigator surfaces.
- **B2B** — bulk purchasing, invoicing, business accounts.
- **International expansion** — multi-currency display, non-MAD regions,
  localisation beyond French.
- **Seasonal branding** — themed storefront skins for events/holidays.
